        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex flex-col items-start gap-4 mb-5">
              ...
              <img src="/christ-logo.png" alt="Christ University Logo" className="h-14 object-contain opacity-95" />
            </div>
            ...
            <div className="flex gap-2.5 pt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-[#CD0000] hover:text-white transition-all shadow-xs"
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-slate-800 font-bold mb-5 text-xs uppercase tracking-wider">Quick Links</h4>
          ...
          <div className="grid grid-cols-2 gap-4 col-span-1 sm:col-span-2 md:col-span-2 lg:col-span-2">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['AI HUB', 'DevZen', 'Synapse', 'InsightX', 'Research Guidance'].map(v => (
                  <li key={v}>
                    <Link
                      href="/verticals"
                      className="text-slate-500 hover:text-[#CD0000] text-xs font-semibold transition-colors inline-block"
          ...
          {/* Connect */}
          <div>
            <h4 className="text-slate-800 font-bold mb-5 text-xs uppercase tracking-wider">Connect</h4>
