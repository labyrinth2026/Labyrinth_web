      ...
      <section className="py-24 bg-slate-50/50">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            ...
            <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.05 }} className="flex flex-col">
              <div className="bg-white border border-slate-200/80 rounded-2xl p-8 md:p-10 flex-1 flex flex-col justify-center text-center shadow-xs">
                ...
                <button
                  ...
                  className="mx-auto flex items-center gap-2 px-6 py-3 bg-[#CD0000] text-white font-bold uppercase tracking-wider text-[10px] rounded-full hover:bg-[#9E0000] transition-all hover:scale-102 active:scale-98 disabled:opacity-75 shadow-xs"
                >
                  {isLoadingForm ? (
            ...
            {/* ── Right: Contact Info ── */}
            <motion.div initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.1 }} className="space-y-6 flex flex-col justify-between">

              {/* Faculty Coordinator Card */}
              <div className="bg-slate-900 border border-slate-900 rounded-2xl p-8 text-white relative overflow-hidden group shadow-sm flex flex-col justify-center">
              ...
              <div className="bg-white border border-slate-200/80 rounded-2xl p-8 shadow-xs flex-1 flex flex-col justify-center">
