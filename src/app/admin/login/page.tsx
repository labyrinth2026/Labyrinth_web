...
export default function AdminLoginPage() {
  ...
  useEffect(() => {
    ...
    if (user && (user.role === 'HOD' || user.role === 'COORDINATOR' || user.role === 'ASSOCIATE')) {
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight font-grotesk">
            ADMIN <span className="text-[#CD0000]">PORTAL</span>
          </h1>
          <p className="text-slate-400 text-xs mt-2">
            Shared gateway for HOD, Coordinators, and Faculty Associates.
          </p>
        </div>
